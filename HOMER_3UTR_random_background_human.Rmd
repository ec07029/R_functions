...
```{r setwd}
folder <- "~/mount/chuk/MOLM13/MOLM13_Yuheng_samples_re-run_with_20191114_pipeline/HOMER/"
save.folder <- "~/mount/chuk/MOLM13/MOLM13_Yuheng_samples_re-run_with_20191114_pipeline/HOMER/"
```

Import data.

```{r import}
df <- read.xlsx("~/mount/chuk/data_resources/molm13_snp_counts_dedupped_significant.xlsx")
