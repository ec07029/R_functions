...
anno$annotation <- "NA"
intronbytx <- intronsByTranscript(TxDb.Hsapiens.UCSC.hg19.knownGene) 
cdsbytx <- cds(TxDb.Hsapiens.UCSC.hg19.knownGene) 
...
write.xlsx( df, file = "MOLM13_MSI2_HyperTRIBE_snp_counts.xlsx" )
